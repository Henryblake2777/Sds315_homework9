...
According to the model, Whole foods and Wheatsville Food Co-Op are the two most expensive stores, while Kroger and Kroger Fresh Fare were the two cheapest

## Part E - Price Discrimination

While building the linear model, the product type is held constant, which means that Central Market does charge more per item> however, this is only around 7 cents more, which is a lot smaller of a difference compared to other stores.
